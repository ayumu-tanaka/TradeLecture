# 国際貿易理論・重力方程式に関する講義資料

このリポジトリは、国際貿易理論・重力方程式に関する講義資料のコレクションです。
...
### 講演資料
- [新々貿易理論：生産性は本当に重要なのか？](keio01.pdf)
- [貿易と労働: 輸出企業の賃金はなぜ高いのか](keio02.pdf)
- [貿易と労働に関する最近の研究: サーベイと分析手法](JSIE-Tanaka-50min.pdf)

---

## 重力方程式 (Gravity Equation)

貿易フローを分析するための標準的な手法である重力方程式に関する資料です。

### 重力方程式の理論と推定
- [Anderson and Wincoop (2003)](AndersonWincoop2003.pdf) ([スライド](AndersonWincoop2003Slides.pdf)) - 理論的に整合的な重力方程式の導出。
- [Head and Mayer (2014)](Head_Mayer2014.pdf) - 重力方程式の推定に関する包括的なガイドライン。
- [Head and Mayer (2021)](Head_Mayer2021.pdf) - ヨーロッパ合衆国/合州国。
- [WTO and UNCTAD (2012, Chapter 3)](ch03_gravity.pdf) - 重力方程式の基礎理論と推定の解説。
- [Helpman, Melitz and Rubinstein (2008)](HMR2008.pdf) - 企業の異質性と貿易障壁の影響。
- [Santos Silva and Tenreyro (2006)](SantosSilva_Tenreyro2006Slides1.pdf) ([スライド1](SantosSilva_Tenreyro2006Slides1.pdf) / [スライド2](SantosSilva_Tenreyro2006Slides2.pdf)) - PPML推定法を用いた貿易データの分析。
...
- [**重力方程式の推定ガイド (Gravity.md)**](Gravity.md)
  - 貿易データの処理、固定効果、PPML、差の差推定（DID）などの RPubs チュートリアルへのリンク集。
